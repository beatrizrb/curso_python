...
class Direcoes(enum.Enum):
    ESQUERDA = enum.auto() # essa função nao me preocupo com numeraão
    # ele enumera automaticamente com.auto()
    DIREITA = enum.auto()
    ACIMA = enum.auto()
    ABAIXO = enum.auto()
...
# acima primeiro eu acesso a chave e depois o valor enumerado
# Direcoes é um tipo, por isso sinalizo que tem que ser desse tipo
