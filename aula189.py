...
#     - escrita - POST(criar), PUT (substitui), PATCH (atualiza), DELETE
...
# o comando -m executa o modulo como um script
# 3000 é uma porta
# python -m http.server -d aula190_site/ 3000
# com o comando acima, o seu computador hospeda o site na internet