...
class Log(ABC):
    # é uma classe abstrata porque herda de abc e tem o metodo abaixo abstrato
    # essa classe é abstrata o que significa que Log nao pode ser usado
    # diretamente
    # para eu usar ela eu tenho que herdar ela em outra classe
    # o metodo abstrato tem que ser implementado nas subclasses
    @abstractmethod
    def _log(self, msg): ...
