...
# SystemRandom é uma classe,abaixo no print estao instanciando a classe
# ascii_letters sao letras minusculas e maisculas
# s.digit sao os numeros
# o join é para unir os caracteres escolhidos que estao em uma lista em 
# uma string só (que vai ser a senha) 
print('Senha:',''.join(Sr().choices(s.ascii_letters + s.digits + s.punctuation, k=64)))
# embaixo da para por esse comando direto no terminal
